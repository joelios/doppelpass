...
ath.intl = {
	de_de: {
		...
		android: '<strong>Dies ist eine Web-App</strong><br>Fügen Sie die Web-App bitte zuerst zu Ihrem Home-Bildschirm hinzu. Öffnen Sie dazu das Menü und tippen dann auf <strong>Zum Startbildschirm hinzufügen</strong>. <small>Wenn Ihr Gerät eine Menütaste hat, lässt sich das Browsermenü über diese öffnen. Ansonsten tippen Sie auf %icon.</small>'
	},
	en_us: {
		ios: '<strong>Dies ist eine Web-App</strong><br>Fügen Sie die Web-App bitte zuerst zu Ihrem Home-Bildschirm hinzu. Tippen Sie dafür auf %icon und dann <strong>Zum Home-Bildschirm</strong>.<br>Starten Sie anschliessend die Web-App von Ihrem Homebildschirm aus neu.',
		android: '<strong>Dies ist eine Web-App</strong><br>Fügen Sie die Web-App bitte zuerst zu Ihrem Home-Bildschirm hinzu. Öffnen Sie dazu das Menü und tippen dann auf <strong>Zum Startbildschirm hinzufügen</strong>. <small>Wenn Ihr Gerät eine Menütaste hat, lässt sich das Browsermenü über diese öffnen. Ansonsten tippen Sie auf %icon.</small>'
